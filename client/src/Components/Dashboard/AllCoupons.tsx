...
import { useCreateCouponMutation, useGetAllCouponsQuery } from "../../Redux/rtk/couponApi";
    ...
    <div>
      ...
      {isModalOpen && (
        <CustomModal onClose={handleClose} isOpen={isModalOpen}>
          ...
          >
            {() => (
              <Form className="w-96 p-4 flex flex-col gap-4 h-96 overflow-scroll">
                <div>
                  <label
                    htmlFor="code"
